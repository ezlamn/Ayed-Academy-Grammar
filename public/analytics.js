...
window.SmartAnalytics = {
  ...
  renderDashboardStats: function() {
    ...
    let html = `<div class="analytics-card" style="padding: 2rem; margin-top: 2rem;">
      ...
      html += `
        <div style="margin-bottom: 1rem;">
          <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
            <span class="an-cat-label" style="text-transform: uppercase;">${cat}</span>
            <span class="an-cat-percent">${percent}%</span>
          </div>
          <div class="an-track">
